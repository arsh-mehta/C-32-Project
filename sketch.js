...
async function getBackgroundImg(){
    ...
    else if(hour>=08 && hour<=10 ) bg = "sunrise3.png"
    else if(hour>=10 && hour<=12 ) bg = "sunrise4.png"
    else if(hour>=12 && hour<=14 ) bg = "sunrise5.png"
    else if(hour>=14 && hour<=16 ) bg = "sunrise6.png"
    else if(hour>=16 && hour<=18 ) bg = "sunset7.png"
